...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		...
		serviceReference=context.getServiceReference(RecurringDepositCalc.class.getName());
		RecurringDepositCalc rdCal=(RecurringDepositCalc) context.getService(serviceReference);
		System.out.println(rdCal.RDCalc());
